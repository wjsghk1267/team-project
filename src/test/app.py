from models import load_yolo_model, load_lstm_model, process_yolo_results, predict_dog_behavior
...
from config import YOLO_MODEL_PATH, LSTM_MODEL_PATH, CONF_THRESH, breed_mapping, GPT_MODEL, client
import os
from utils import get_most_common_breed
...
def main():
    ...
    lstm_text, associated_metadata = predict_dog_behavior(
        lstm_keypoint_sequence, skeleton_sequence, lstm_model, device, all_class_names, metadata
    )
